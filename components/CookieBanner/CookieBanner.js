  ...
  return (
    <>  
      {!manageCookies && (
        ...
        > 
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", maxWidth: "700px", zIndex: "1000" }}>
      ...
      {manageCookies && (
        <div style={{ position: "sticky", bottom: "0", left: "0", right: "0", zIndex: "1000", backgroundColor: "white", padding: "10px", borderTop: "1px solid #e0e0e0" }}>
