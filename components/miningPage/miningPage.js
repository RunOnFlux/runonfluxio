                ...
                <div className="container">
                    ...
                    <div className="row mt-5">
                     ...
                     <div className={styles.videoEmbed}>
                        <iframe style="border: 0;" height="500" width="100%" src="https://www.youtube.com/embed/fulcZGdGs64" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                     </div>
                    </div>
                </div>
