                ...
                <div className={styles.socials}>
                    <div className={styles.div1}>
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>Twitter</a>
                        </div>
                    </div>
                    <div className={styles.div2}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>Discord</a>
                        </div>
                    </div>
                    <div className={styles.div3}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>Facebook</a>
                        </div>
                    </div>
                    <div className={styles.div4}> 
                     <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>Bitcoin Talk</a>
                        </div>
                    </div>
                    <div className={styles.div5}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>Telegram</a>
                        </div>
                    </div>
                    ...
                    <div className={styles.div7}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>Youtube</a>
                        </div>
                    </div>
                    <div className={styles.div8}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>Reddit</a>
                        </div>
                    </div>
                    <div className={styles.div9}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>Medium</a>
                        </div>
                    </div>
                    <div className={styles.div10}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>LinkedIn</a>
                        </div>
                    </div>
                    <div className={styles.div11}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>Twitch</a>
                        </div>
                    </div>
                    <div className={styles.div12}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>Instagram</a>
                        </div></div>
                    <div className={styles.div13}> 
                        <div className={styles.card}>
                            <Image className={styles.cardImg} alt={"img"} src={tiktokImg}></Image>
                            <br></br>
                            <a className={styles.btn}>TikTok</a>
                        </div>
                    </div>
                ...
                <div className={styles.parent}>
                    <div className={styles.div1}> 
                        <div className={styles.ambCard}>
                            ...
                            <div className={styles.links}>
                                <Image className={styles.rightBord} src={icon_twitter}></Image>
                                <Image className={styles.noBord} src={icon_medium}></Image>
                                <Image className={styles.centerBordTele} src={icon_telegram}></Image>
                                <Image className={styles.noBord} src={icon_facebook}></Image>
                                <Image className={styles.leftBord} src={icon_instagram}></Image>
                            </div>
                        </div>
                    </div>
                    <div className={styles.div2}> 
                        <div className={styles.ambCard}>
                            ...
                            <div className={styles.links}>
                                <Image className={styles.rightBord} src={icon_twitter}></Image>
                                <Image className={styles.noBord} src={icon_medium}></Image>
                                <Image className={styles.leftBordTele} src={icon_telegram}></Image>
                            </div>
                        </div>
                    </div>
                    <div className={styles.div3}> 
                        <div className={styles.ambCard}>
                            ...
                            <div className={styles.links}>
                                <Image className={styles.noBord} src={icon_twitter}></Image>
                            </div>
                        </div>
                    </div>
                    <div className={styles.div4}> 
                    ...
                    <div className={styles.div6}> 
                        <div className={styles.ambCard}>
                            ...
                            <div className={styles.links}>
                                <Image className={styles.rightBord} src={icon_twitter}></Image>
                                <Image className={styles.noBord} src={icon_instagram}></Image>
                            </div>
                        </div>
                    </div>
                    <div className={styles.div7}> 
                    ...
                    <div className={styles.div23}> 
                        <div className={styles.ambCard}>
                            ...
                            <div className={styles.links}>
                                <Image className={styles.noBord} src={icon_twitter}></Image>
                                <Image className={styles.centerBord} src={icon_medium}></Image>
                                <Image className={styles.noBord} src={icon_facebook}></Image>
                            </div>
                        </div></div>
                ...
                <div className={styles.comMedia}>
                    <div className={styles.div1}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>/flux_reports</a>
                        </div>
                    </div>
                    <div className={styles.div2}> 
                        <div className={styles.card}>
                            <Image className={styles.cardImg} alt={"img"} src={icon_greyTwitter}></Image>
                            <br></br>
                            <a className={styles.btn}>/ExploreLbry</a>
                        </div>
                    </div>
                    <div className={styles.div3}> 
                        <div className={styles.card}>
                            ...
                            <br></br>
                            <a className={styles.btn}>TSN Crypto</a>
                        </div>
                    </div>
                    <div className={styles.div4}> 
                        <div className={styles.card}>
                            <Image className={styles.cardImg} alt={"img"} src={icon_globe}></Image>
                            <br></br>
                            <a className={styles.btn}>Jefke’s Blog</a>
                        </div>
                    </div>
                    <div className={styles.div5}> 
                        <div className={styles.card}>
                            <Image className={styles.cardImg} alt={"img"} src={icon_greyTwitter}></Image>
                            <br></br>
                            <a className={styles.btn}>/wponflux</a>
                        </div>
                    </div>
                    <div className={styles.div6}> 
                        <div className={styles.card}>
