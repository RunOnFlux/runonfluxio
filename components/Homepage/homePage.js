                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6 mb-4 mt-3">
                            <div className={styles.card1}>
                                ...
                                <h5>Redundancy</h5>
                                <h6>Redundant applications and automated failover during outages</h6>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6 mb-4 mt-3">
                        <div className={styles.card1}>
            ...
            <section className={styles.section6}>
                <div className="container">
                    <div className="row text-center mb-4">
                        ...
                        <p className="mb-4">Flux Cloud is connected worldwide, across all continents. Its strongest Availability Zones are the EU and United States. South Asia and Australia are also witnessing an increase in server deployments. Flux Cloud is the most decentralized and fastest growing network in the world.</p>
                    </div>
                    <div className="row">
