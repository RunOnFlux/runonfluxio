            ...
            <section className={styles.team}>
                <div className="container">
                    ...
                    <div className="row">
                        {teamAsset.map((item) =>{
                            return(
                             <div className="col-lg-4 col-md-6 col-sm-6 col-12" key={item.name}>
                             <TeamCard name={item.name} src={item.thumbnail}  twitterLink={item.twitterLink} linkedInLink={item.linkedInLink} title={item.title} description={item.description} />
                         </div>)
